...
public class FeedsActivity extends Activity implements OnItemClickListener {
	...
	private void loadFeeds() {
		...
		Stream.getStream(this, null, myFeed.getId(), "tags",new Stream.StreamListener() {
		 ...
		 * 
		 * @Override public void onSuccess(ArrayList<Feed> feeds) { adapter =
		 * new FeedArrayAdapter(FeedsActivity.this, feeds);
	...
	public void onItemClick(AdapterView<?> adapterView, View view,
		...
		feedDetail.putExtra(FeedDetailActivity.INPUT_SELECTED_FEED,
				selectedFeed);
