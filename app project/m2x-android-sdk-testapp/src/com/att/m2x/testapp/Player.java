...
public class Player extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView.loadUrl("http://www.skippl.co/heatmap1.png");
		name = (TextView) findViewById(R.id.tvWhosIt);
	...
	private void loadFeeds() {
		...
		Feed.getFeed(this, null, "1809ad358b8d17350bc8d95bb8d5b519",
				new Feed.FeedListener() {
					public void onSuccess(Feed feed) {
						myFeed = feed;
						Stream.getStream(Player.this, null, myFeed.getId(),
								"tags", new Stream.StreamListener() {
	...
	private void sendToM2X(String readMessage) {
		...
		value.setValue(1.0);
		readings.add(value);
		tagStream.setValues(this, null, myFeed.getId(), readings,
				new Stream.BasicListener() {
